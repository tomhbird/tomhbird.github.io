...
::: {.column-margin}
::: {.sticky-note}
📌 *This article is written in Quarto and hosted via GitHub Pages. As a Cognitive Neuroscience graduate who enjoys a bit of coding here and there, I wanted to use this project to demonstrate what I can do, from clean reproducible document production to custom styling and interactive elements. If you've landed here from my LinkedIn or GitHub, I hope the code is as interesting as the content.*
:::
...
![](images/compressed_IMG_5861.jpeg){description="Who would've though a bucket of mystery spirits and sugar would be a bad idea for a diabetic?"}
...
![](images/compressed_IMG_7415.jpeg){description="How I miss wondering into unassuming resturants in Japan and getting served an absolute 10/10 meal."}
...
![](images/compressed_IMG_7919.jpeg){description="One of our last meals of the trip. The chef combined his knowledge of South Korean cuisine with his travels to create some insaneley delicious fusion dishes."}

![](images/compressed_IMG_6963.jpeg){description="The meals at the homestay's in Vietnam were always the best."}
