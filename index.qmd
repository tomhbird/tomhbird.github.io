  ...
  <div class="mobile-gallery-track-wrapper">
    <div class="mobile-gallery-track" id="galleryTrack">
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_3634.jpeg" alt="Hiked from the Hollywood sign down to Griffith Observatory.">
        <p>Hiked from the Hollywood sign down to Griffith Observatory.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_4035.jpeg" alt="Some of the Melbourne family.">
        <p>Some of the Melbourne family.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_4417.jpeg" alt="Australian Open, Djokovic vs. Basavareddy.">
        <p>Australian Open, Djokovic vs. Basavareddy.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_45478592.jpg" alt="Reunion after a very wet and stormy Whitsundays tour.">
        <p>Reunion after a very wet and stormy Whitsundays tour.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_4141.JPG" alt="K'Gari gang, better known as the Dingo Divas.">
        <p>K'Gari gang, better known as the Dingo Divas.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_5125.jpeg" alt="First glacier. Mount Cook delivered.">
        <p>First glacier. Mount Cook delivered.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_4651.JPG" alt="Nevis Bungy. After being explicitly told not to jump feet first, I did just that.">
        <p>Nevis Bungy. After being explicitly told not to jump feet first, I did just that.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_1082.jpeg" alt="Started at 2am, sprained ankle, pitch black, four hours of uphill. Turns out a sunrise at the top of Roy's Peak is worth every single hobbled step.">
      ...
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_5861.jpeg" alt="Who would've thought a bucket of mystery spirits and sugar would be a bad idea for a diabetic?">
        <p>Who would've thought a bucket of mystery spirits and sugar would be a bad idea for a diabetic?</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_6318.jpeg" alt="Vertically climbed a rock face using a dodgy rope to get this pic. Koh Tao was far too pretty.">
        <p>Vertically climbed a rock face using a dodgy rope to get this pic. Koh Tao was far too pretty.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_6204.jpeg" alt="Fire dancer on Koh Phi Phi. One of those evenings that's hard to describe to someone who wasn't there.">
        <p>Fire dancer on Koh Phi Phi. One of those evenings that's hard to describe to someone who wasn't there.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_6703.jpeg" alt="What I wouldn't give to do the Ha Giang loop again.">
        <p>What I wouldn't give to do the Ha Giang loop again.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_7199.jpeg" alt="Vietnamese cooking class in Hoi An.">
        <p>Vietnamese cooking class in Hoi An.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_7754.jpeg" alt="Mount Fuji doing the heavy lifting in this pic.">
        <p>Mount Fuji doing the heavy lifting in this pic.</p>
      </div>
      <div class="mobile-gallery-slide">
        <img src="images/compressed_IMG_7919.jpeg" alt="One of our last meals of the trip. The chef combined his knowledge of South Korean cuisine with his travels to create some insanely delicious fusion dishes.">
