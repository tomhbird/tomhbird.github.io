...
![](images/compressed_IMG_4644.jpeg){description="Ophelia. She was an absolute beast."}
...
![](images/compressed_IMG_6673.jpeg){description="Another stunner from the loop."}
...
![](images/compressed_IMG_3882.jpeg){description="Daily changs on the Khao San Road are a must."}
...
![](images/compressed_IMG_6928.jpeg){description="Is it obvious enough that I did the Ha Giang loop yet?"}

![](images/compressed_IMG_7557.jpeg){description="Japanese architecture combined with its landscape is unrivaled."}
